...
//------------------------------------------------------------------------------
WindowApplication::WindowApplication(std::string title):
	Application(),
	m_fullScreen(false),
	m_runFlag(false),
	m_title(title)
...
//------------------------------------------------------------------------------
void WindowApplication::setFullScreen(bool fullScreen)
{
...
//------------------------------------------------------------------------------
sf::Vector2i WindowApplication::screenSize() const
{
...
//------------------------------------------------------------------------------
sf::Vector2i WindowApplication::mousePosition() const
{
	return sf::Mouse::getPosition(m_window);
}

//------------------------------------------------------------------------------
void WindowApplication::setSystemCursorVisible(bool visible)
{
...
bool WindowApplication::init()
{
	...
	registerNativeUserClasses(ObjectTypeDatabase::get());
...
//------------------------------------------------------------------------------
void WindowApplication::onScreenResize(sf::Vector2u size)
{
